  ...
  return (
    <div className="w-[468px] bg-white p-4 mt-1">
      ...
      <div className="flex justify-between items-center mb-2">
        ...
        <button className="text-gray-700 hover:text-black">
          <img
            className="w-6 h-5 relative left-3 bottom-2 md:left-3 lg:left-3 xxxs:-left-[107px] xs:-left-9 xxs:-left-24"
            src="save.png"
            alt="Save"
          />
        </button>
      ...
      <div className="text-sm leading-snug whitespace-pre-line">
        <span className="font-semibold relative right-3 xxs:-left-1 xxxs:-left-0 md:-left-3 lg:-left-2 xs:-left-1">
          {post.username}
        </span>
      ...
      <div className="mt-4 flex items-center">
        ...
        <div className="relative left-5 group w-10 ">
          <img
            src="emoji.png"
            alt="emoji"
            className="relative w-5 h-5 cursor-pointer xs:-left-11 xxs:-left-[105px] xxxs:-left-[113px] md:-left-0 lg:-left-0 xl:-left-0 2xl:-left-0"
          />
